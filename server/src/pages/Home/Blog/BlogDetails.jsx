    ...
    <section id="blog-details">
      <div className="blog-details-main">
        <div className="blog-details-title-div">
          ...
          <h2 className="blog-details-title">Title of Blog</h2>
        </div>
        <div className="blog-details-card">
          ...
          <div className="blog-details-part2-entry">
            ...
            <p>
              ...
              section 1.10.32. The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. 
            ...
            <p>
              ...
              words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
            </p>
          </div>
          <div className="blog-details-part3-4-row">
              <div className="blog-details-part3-image-div">
                <img src={BlogDetailsImg3}/>
              </div>
              <div className="blog-details-part4-image-div">
                <img src={BlogDetailsImg4}/>
              </div>
            </div>
        </div>
      </div>
