...
namespace Oap.WebApp.Interfaces
{
    public interface IProfileApplication
    {
        ...
        Task<List<UserApplicationCardDto>> GetAllDraftCardsAsync(Guid ownerUserId);
        Task<CreateUserApplicationResult> CreateDraftCopyAsync(Guid ownerUserId, Guid sourceAppId, UpdateUserApplicationFormRequest request);
        ...
        Task<List<UserApplicationCardDto>> SearchDraftCardsAsync(Guid ownerUserId, string? query, string? sort);
